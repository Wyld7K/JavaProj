...
public class GUI extends JFrame implements ActionListener, FocusListener {
    ...
    public GUI(String title) {
        ...
        submitButton.setToolTipText("Girrafes r c00l");
        ...
        String[] taskList = { "Select:", "pythonJavaCase", "okayLineUp", "multString", "phoneNumberFormatter" }; // Add
        // to
        // pulldown
        // menu
        // list of names of tasks to show to user
        ...
        for (int i = 0; i < entry.length; i++)
            entry[i] = new JTextField("", 12); // 12 is the number of characters width
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("taskSelector")) {
            ...
            interactions.showInstructions(selectedTask, report, entry);
